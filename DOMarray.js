...
function randomAnimal() {
  ...
  // vi callbacker ikke her siden vi vil at denne skal kjøres ved å trykke på en knapp

  // html kode som kan brukes (kan legges rett inn i body):

//   <button onclick="randomAnimal()">Generer</button>
//   <div id="randomElementOutPut"></div>
//   <script src="domArray.js"></script>
